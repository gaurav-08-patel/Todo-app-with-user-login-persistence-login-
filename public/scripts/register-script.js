...
form.addEventListener("submit", (e) => {
    ...
    let isRequiredValid = checkRequired([userName, password, confirmPassword]);
    ...
    if (isRequiredValid) {
        ...
        let isPasswordMatch = checkConfirmPassword(password, confirmPassword);

        isFormValid = isUserNameValid && isPasswordValid && isPasswordMatch;
    }
